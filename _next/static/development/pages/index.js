...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./consts */ "./components/consts.js");
...
var Code = function Code(_ref) {
  var exportType = _ref.exportType,
      palette = _ref.palette,
      setExportType = _ref.setExportType,
      className = _ref.className,
      hsl = _ref.hsl,
      props = _objectWithoutProperties(_ref, ["exportType", "palette", "setExportType", "className", "hsl"]);

  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("pre", _extends({
    className: "bg-dark text-white p-3 rounded shadow ".concat(className)
  }, props, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    ...
    __self: this
  }, _consts__WEBPACK_IMPORTED_MODULE_1__["exportTypes"].map(function (type) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      ...
      className: "btn btn-sm btn-outline-light ".concat(exportType === type ? 'bg-light text-dark' : ''),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 17
      },
    ...
    __self: this
  }, exportType === 'json' ? "{\n".concat(Object.keys(palette).map(function (color) {
    return _consts__WEBPACK_IMPORTED_MODULE_1__["lightnessLevels"].map(function (kind) {
      return "  \"".concat(color, "_").concat(kind, "\": \"").concat(hsl(color, kind), "\"");
    }).join(',\n');
  }).join(',\n'), "\n}") : exportType === 'sass' ? Object.keys(palette).map(function (color) {
    return "$".concat(color, ": ").concat(hsl(color, 'tone'), ";");
  }).join('\n') : ":root {\n".concat(Object.keys(palette).map(function (color) {
    return _consts__WEBPACK_IMPORTED_MODULE_1__["lightnessLevels"].map(function (kind) {
      return "  --".concat(color, "_").concat(kind, ": ").concat(hsl(color, kind), ";");
    }).join('\n');
...
/***/ "./components/consts.js":
/*!******************************!*\
  !*** ./components/consts.js ***!
  \******************************/
/*! exports provided: lightnessLevels, exportTypes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lightnessLevels", function() { return lightnessLevels; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "exportTypes", function() { return exportTypes; });
var lightnessLevels = ['shade', 'tone', 'tint'];
var exportTypes = ['css', 'json', 'sass'];
...
/* harmony import */ var _components_index_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/index.scss */ "./components/index.scss");
/* harmony import */ var _components_index_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_index_scss__WEBPACK_IMPORTED_MODULE_3__);
